...
\copy aisles from 'aisles.csv' delimiter ',' csv header;
\copy departments from 'departments.csv' delimiter ',' csv header;
\copy orders from 'orders_small.csv' delimiter ',' csv header;
\copy products from 'products.csv' delimiter ',' csv header;
\copy order_products from 'order_products__train.csv' delimiter ',' csv header;
