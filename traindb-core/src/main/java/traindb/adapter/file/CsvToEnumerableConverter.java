 ...
 */
public class CsvToEnumerableConverter extends ConverterImpl implements EnumerableRel {

  CsvToEnumerableConverter(RelNode input) {
  ...
  public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
    return new CsvToEnumerableConverter(inputs.get(0));
  }
  ...
  public Result implement(EnumerableRelImplementor implementor, Prefer prefer) {
    return ((CsvTableScan) input).implement(implementor, prefer);
  }
