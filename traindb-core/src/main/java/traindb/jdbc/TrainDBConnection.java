...
import org.verdictdb.jdbc41.VerdictPreparedStatement;
import traindb.TrainDBContext;
import traindb.common.TrainDBException;

public class TrainDBConnection implements java.sql.Connection {

  TrainDBContext vc;

  boolean isOpen = false;

  public TrainDBConnection(String url) throws SQLException, TrainDBException {
    vc = TrainDBContext.fromConnectionString(url);
    isOpen = true;
  }

  public TrainDBConnection(String url, Properties info) throws SQLException, TrainDBException {
    vc = TrainDBContext.fromConnectionString(url, info);
    isOpen = true;
  }
  ...
  public java.sql.Statement createStatement() throws SQLException {
    ...
    // shared.
    return new TrainDBStatement(this, vc);
  }
  ...
  @Override
  public TrainDBStatement createStatement(int resultSetType, int resultSetConcurrency)
      throws SQLException {
    throw new SQLFeatureNotSupportedException();
  }
  ...
  @Override
  public TrainDBStatement createStatement(
